...
@ options passed:  -fpreprocessed .pio\build\due\FrameworkArduino\hooks.c.i
@ -mcpu=cortex-m3 -mthumb
@ -auxbase-strip .pio\build\due\FrameworkArduino\hooks.c.o -Os
...
@ C:\Users\HUAWEI\.platformio\packages\framework-arduino-sam\cores\arduino\hooks.c:30: }
	bx	lr	@
	.size	__empty, .-__empty
	.weak	yield
	.thumb_set yield,__empty
	.section	.text.__false,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	__false, %function
__false:
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ C:\Users\HUAWEI\.platformio\packages\framework-arduino-sam\cores\arduino\hooks.c:42: }
	movs	r0, #0	@,
	bx	lr	@
	.size	__false, .-__false
	.weak	sysTickHook
	.thumb_set sysTickHook,__false
...
.L4:
	...
	.size	__halt, .-__halt
	.weak	pendSVHook
	.thumb_set pendSVHook,__halt
	.weak	svcHook
	.thumb_set svcHook,__halt
