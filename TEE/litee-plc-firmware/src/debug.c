...
static const struct {
    ...
    {&(RES0__INSTANCE0.COUNTER_ENABLE), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.COUNTER_RESET), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.COUNTER_Q), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.COUNTER_MAX), INT_O_ENUM},
    {&(RES0__INSTANCE0.COUNTER_VALUE), INT_O_ENUM},
